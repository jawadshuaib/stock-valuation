...
export default function ValuationResults() {
  ...
  useEffect(() => {
    if (selector.simulation) {
      ...
      if (
        selector.simulation.median !== undefined &&
        selector.simulation.percentile1 !== undefined
      ) {
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-white rounded-lg shadow-sm border border-blue-100">
          <div className="flex items-center text-sm font-medium text-gray-500 mb-1">
            ...
            <Tooltip
              content="The margin of safety is determined statistically using the 1st percentile of the simulated valuations."
              style="light"
            >
