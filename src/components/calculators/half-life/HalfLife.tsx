  ...
  return (
    <section className="mt-8 p-6 bg-white rounded-lg border border-blue-100 shadow-sm">
      ...
      <p className="text-lg mb-4">
        ...
        valuation metrics are expected to decline, providing insight into the
        company&apos;s future performance and potential risks.
      </p>
      <p className="text-lg">
        Companies with a half life of less than 10 years are considered to have
        a high growth potential, while those with a half life of more than 10
        years are considered to be mature companies with stable growth. This
        investment has a half life of {halfLife} years. Which is great! ✅
      </p>
    </section>
  );
}
